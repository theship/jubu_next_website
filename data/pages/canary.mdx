...
[0] https://juleeburdekin.com/transparency
...
```bash
curl https://juleeburdekin.com/docs/dergigi.pub.asc | gpg --import
```
...
gpg: Good signature from "Gigi D. <gigi@juleeburdekin.com>" [ultimate]
```
